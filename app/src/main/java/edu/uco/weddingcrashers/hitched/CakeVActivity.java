...
public class CakeVActivity extends CakeSingleFragmentActivity {
    ...
    public static Intent newIntent(Context packageContext, String placeID, String iconURL){
        Intent intent = new Intent(packageContext,CakeVActivity.class);
    ...
    protected Fragment createFragment() {
        ...
        return CakeFragment.newInstance(placeID, iconURL);
    }
