 ...
 */
public class CakeVDetailActivity extends CakeSingleFragmentActivity {
    ...
    public static Intent newIntent(Context packageContext, UUID vendorID){
        Intent intent = new Intent(packageContext,CakeVDetailActivity.class);
    ...
    protected Fragment createFragment() {
        ...
        return CakeDetailFragment.newInstance(vendorID);
    }
}
