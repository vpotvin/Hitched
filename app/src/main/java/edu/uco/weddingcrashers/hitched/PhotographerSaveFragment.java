 ...
 */
public class PhotographerSaveFragment extends DialogFragment implements AdapterView.OnItemSelectedListener {
    private static final String ARG_URL = "url";
    private  String userState;
    private Spinner mSpinner;

    public static PhotographerSaveFragment newInstance(String url){
        Bundle args = new Bundle();
        args.putString(ARG_URL,url);

        PhotographerSaveFragment fragment = new PhotographerSaveFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.dialog_save_photographer,null);
        ...
        return new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton("Submit", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Intent intent = new Intent(getActivity(),PhotographerPDetailActivity.class);
