...
public class PhotographerVActivity extends PhotographerSingleFragmentActivity {
    ...
    public static Intent newIntent(Context packageContext, String placeID, String iconURL){
        Intent intent = new Intent(packageContext,PhotographerVActivity.class);
    ...
    protected Fragment createFragment() {
        ...
        return PhotographerFragment.newInstance(placeID, iconURL);
    }
